...
{
    [TestClass]
    public class CartesianModeRelativePtpMotionInstructionShould
    {
        [TestMethod]
        public void ProduceCorrectlyFormattedGCode()
        {
            var testObject = new CartesianModeRelativePtpMotionInstruction();
            ...
            Assert.AreEqual("M20 G91 G0 X1.1 Y2.2 Z3.3 A4.4 B5.5 C6.6 F2000", testResult);
        }
    }
}
