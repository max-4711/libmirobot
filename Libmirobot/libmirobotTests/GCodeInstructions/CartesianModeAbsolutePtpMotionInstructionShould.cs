...
{
    [TestClass]
    public class CartesianModeAbsolutePtpMotionInstructionShould
    {
        [TestMethod]
        public void ProduceCorrectlyFormattedGCode()
        {
            var testObject = new CartesianModeAbsolutePtpMotionInstruction();
            ...
            Assert.AreEqual("M20 G90 G0 X1.1 Y2.2 Z3.3 A4.4 B5.5 C6.6 F2000", testResult);
        }
    }
}
