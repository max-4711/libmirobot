...
{
    [TestClass]
    public class AngleModeRelativeMotionInstructionShould
    {
        [TestMethod]
        public void ProduceCorrectlyFormattedGCode()
        {
            var testObject = new AngleModeIncrementalMotionInstruction();
            ...
            Assert.AreEqual("M21 G91 X1.1 Y2.2 Z3.3 A4.4 B5.5 C6.6 F2000", testResult);
        }
    }
}
