...
{
    [TestClass]
    public class AngleModeAbsoluteMotionInstructionShould
    {
        [TestMethod]
        public void ProduceCorrectlyFormattedGCode()
        {
            var testObject = new AngleModeAbsoluteMotionInstruction();
            ...
            Assert.AreEqual("M21 G90 X1.1 Y2.2 Z3.3 A4.4 B5.5 C6.6 F2000", testResult);
        }
    }
}
